...
for dtime in ['[6, 18]']:
    for disc in ['0.005']:
        ...
        lfiles.append('bcntwitter-septemberbin-labels-affinity-minloc20-minsize20-timed%s-damp0.5-nusr50#70000-r%s' % (
        dtime, disc))
        #lfiles.append('bcntwitter-septemberbin-labels-affinity-minloc20-minsize20-timed%s-damp0.75-nusr50#70000-r%s' % (dtime, disc))
        lfiles.append(
            'bcntwitter-septemberbin-labels-affinity-minloc20-minsize20-timed%s-damp0.999-nusr50#70000-r%s' % (
            dtime, disc))
        lfiles.append('bcntwitter-septemberbin-labels-kmeans-minloc20-minsize20-timed%s-nclust60-nusr50#70000-r%s' % (
        dtime, disc))
        lfiles.append('bcntwitter-septemberbin-labels-kmeans-minloc20-minsize20-timed%s-nclust80-nusr50#70000-r%s' % (
        dtime, disc))
        lfiles.append('bcntwitter-septemberbin-labels-kmeans-minloc20-minsize20-timed%s-nclust100-nusr50#70000-r%s' % (
        dtime, disc))
        lfiles.append('bcntwitter-septemberbin-labels-spectral-minloc20-minsize20-timed%s-nclust60-nusr50#70000-r%s' % (
        dtime, disc))
        lfiles.append('bcntwitter-septemberbin-labels-spectral-minloc20-minsize20-timed%s-nclust80-nusr50#70000-r%s' % (
        dtime, disc))
        lfiles.append(
            'bcntwitter-septemberbin-labels-spectral-minloc20-minsize20-timed%s-nclust100-nusr50#70000-r%s' % (
            dtime, disc))
        print '-------------\n', dtime, disc
        compute_sim(lfiles)
